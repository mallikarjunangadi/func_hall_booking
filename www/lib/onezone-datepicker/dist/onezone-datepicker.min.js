! function(e, t) {
        ...
        if (angular.isDefined(e) && angular.isArray(e) && e.length > 0)
            for (var a = 0; a < e.length; a++) {
                ...
                if (angular.isDefined(n.date) && u(t, n.date)) {
                    var isdate = false; 
                    if(angular.isDefined($rootScope.diffEvents)) { 
                      if($rootScope.diffEvents.indexOf(n.date.toString()) > -1){
                        isdate = true;
                       }
                    } 
...
}), angular.module("onezone-datepicker", ["ionic", "onezone-datepicker.templates", "onezone-datepicker.service"]).directive("onezoneDatepicker", ["$ionicGesture", "onezoneDatepickerService", "$rootScope","myService", function(e, t, $rootScope,myService) {
    "use strict";
    ...
    var r = function(e, r, o) {
        ...
        var selecteDte=String((e.selectedDate.getDate() < 10 ? '0' : '')+ e.selectedDate.getDate()+'/'+(((e.selectedDate.getMonth() + 1) < 10 ? '0' : '') + (e.selectedDate.getMonth() + 1))+'/'+e.selectedDate.getFullYear());
        $rootScope.eventDiscription(selecteDte);
           ...
           $rootScope.getEventList(myService.getEvent(),e.currentMonth.getMonth()+1);
             
           // $rootScope.displayMonthEvents(e.currentMonth);
        ...
        }), e.$watchCollection("datepickerObject.highlights", function() {
            a(e)
